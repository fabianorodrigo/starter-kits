...
export type RedisClient = RedisClientType<
  {
    ...
    json: {
      ...
      arrLen: typeof import("@redis/json/dist/commands/ARRLEN"); // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      get: typeof import(//     `${this.prefix} does not have an id, try create it instead`
      //   );
      // }
      ...
      // }
      // return entity;
      mGet: typeof import("@redis/json/dist/commands/MGET"); // // update person
      // if (result.id == entity.id) {
      //   this._db[entity.id as number] = entity;
      //   await this.overWriteDB(this._db);
      // } else {
      ...
      numIncrBy: typeof import("@redis/json/dist/commands/NUMINCRBY");
      NUMMULTBY: //   throw new ApplicationError("The ID attribute can't be modified");
      // }
      // return entity;
      typeof import(// }
      // return entity;
      "@redis/json/dist/commands/NUMMULTBY");
